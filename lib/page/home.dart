                        ...
                        child: Row(children: [
                          FlatButton(
                              ...
                              child: ClipRRect(
                                  ...
                                  child:
                                      Image.asset('assets/terpopuler-1.png'))),
                          FlatButton(
                              onPressed: () {
                                Navigator.push(
                                    context,
                              ...
                              child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child:
                                      Image.asset('assets/terpopuler-2.png'))),
                          FlatButton(
                              onPressed: () {
                                Navigator.push(
                                    context,
                              ...
                              child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child:
                                      Image.asset('assets/terpopuler-3.png'))),
                          FlatButton(
                              onPressed: () {
                                Navigator.push(
                                    context,
                              ...
                              child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child:
                                      Image.asset('assets/terpopuler-4.png'))),
                          FlatButton(
                              onPressed: () {
                                Navigator.push(
                                    context,
                              ...
                              child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child:
                                      Image.asset('assets/terpopuler-5.png'))),
                        ]))
                  ]))
        ])));
  }
